...
class CountDown extends Component {
  ...
  componentDidMount() {
    // this.deadline = new Date("Oct 08, 2025 21:00:00").getTime();

    var currentDate = new Date();
    currentDate.setDate(currentDate.getDate() + 30);
    this.deadline = currentDate.getTime();

    // var currentDate = new Date();
    // var deadlinee = new Date(currentDate.getTime() + 30 * 24 * 60 * 60 * 1000);
    // this.deadline = deadlinee.getTime();
